package br.com.springmvc.repository.jdbc.mysql;
...
@Repository
public class EntidadeMysqlRepository implements EntidadeRepository {
	 ...
	 */
	@Autowired
	public EntidadeMysqlRepository(@Qualifier("mysqlDataSource") DataSource ds) {
		try {
			this.connection = ds.getConnection();
			connection.prepareStatement("CREATE TABLE IF NOT EXISTS tabela (coluna VARCHAR(100));").execute();
			System.out.println("MYSQL - Conexão com o banco de dados estabelecida com sucesso.");
